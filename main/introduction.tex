...
These methods aim to retain the dominant characteristics of data in a lower-dimensional structure, thereby reducing its dimension \jsm{while capturing the defining within-object structure}. 
