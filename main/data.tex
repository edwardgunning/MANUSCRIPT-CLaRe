...
Glaucoma is considered a leading factor in blindness. It is characterized by damage to the optic nerve, \jsm{which can be induced by} \emph{intraocular pressure (IOP)}. 
...
One study goal for this dataset was to test the hypothesis that scleral strain decreases with age thereby \jsm{leaving the optic nerve head susceptible to damage} which could \jsm{be a contributing factor in the development of} glaucoma \parencite{lee_bayesian_2019}.
{\color{purple}In this work, we use a simulated copy of the real dataset that was made publicly available by \textcite{lee_bayesian_2019}\footnote{\url{https://www.tandfonline.com/doi/suppl/10.1080/01621459.2018.1476242}}}. \jsm{[DO WE HAVE REAL DATA AVAILABLE?]}
