...
\begin{figure}
    ...
    \caption{Diagram highlighting the scope of reliance of the transformation on the data at hand. Methods on towards left assume more structure for the transformation and learn less from the data, whereas methods towards the right assume assume leass structure and learn more from the data.}
