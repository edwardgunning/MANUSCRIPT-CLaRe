...
In most cases, a suitable transformation of the observed object data to a (typically lower-dimensional and Euclidean) space of latent features, which we term a \emph{latent feature representation}, facilitates the application of familiar statistical approaches to the complex objects.
...
The left-hand panel of Figure \ref{fig:viz-options} displays the summary graphic that we have designed 
to accompany our CLaRe framework and is returned by default by our software implementation (GLaRe).
