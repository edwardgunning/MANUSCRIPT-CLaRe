...
\begin{figure}
    \centering
    \includegraphics[width=0.8\linewidth]{figures/continuum-sketch.pdf}
...
When comparing between two methods, for a fixed $\epsilon$ and $\alpha$, we would prefer the method with a smaller qualifying criterion.
}
