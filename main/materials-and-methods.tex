...
\add{We\footnote{Note to self: Generalisation error and CV -- where does this come in?} characterise the degree of information loss of a latent feature representation for each individual observation as
$$
