...
The main function in the \pkg{GLaRe} package is \texttt{GLaRe()}, which computes and summarizes the cross-validated distribution of information loss and implements the CLaRe framework to compute the qualifying dimension for choice of $\alpha$ and $\epsilon$.
