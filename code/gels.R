...
dwt_time <- system.time(gels_dwt.2d <- GLaRe(mat = gels.data, latent_dim_by = 10, latent_dim_to = 8000, learn = "dwt.2d"))
saveRDS(object = list(glare = list(pca = gels_pca, dwt = gels_dwt.2d),
