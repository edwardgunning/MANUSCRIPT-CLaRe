...
The \pkg{GLaRe} package also contains wrapper functions that plots to summarise the cross-validated distribution of information lossses; their outputs are displayed in Figure \ref{fig:additional-plots-01}).
